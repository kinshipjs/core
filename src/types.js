 ...
 * @example
 * ```ts
 * import type { SqlTable } from "@Kinship/Kinship";
...
// Since Kinship is constructed using Proxies, many of the return types are only ever used internally. This may make development harder,
